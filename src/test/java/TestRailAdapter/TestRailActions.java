...
//        if (TestRailSettings.isCreateNewTestRunEachTime) {
//            return createNewTestRunId();
//        } else if (TestRailSettings.isUseLastRun) {
...
//    private int createNewTestRunId() {
//        String runName = TestRailSettings.newTestRunPrefixText + getTimeStamp(TestRailSettings.newTestRunTimeStampFormat);
//        String requestUrl = "https://" + TestRailSettings.siteName + TestRailSettings.testrailEndpointBase
//                + TestRailSettings.testrailEndpointAddRun + TestRailSettings.projectId;
//        String body = "{\"name\": \"" + runName + "\"}";
//        HttpResponse<JsonNode> response = responseBuilderPost(requestUrl, body);
//        int runId = Integer.parseInt(response.getBody().getObject().get("id").toString());
//        System.out.println("Created new Test Run with Id=" + runId);
//        return runId;
//    }
